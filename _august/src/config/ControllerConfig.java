...
//        factoryBean.setConfigLocation(new PathMatchingResourcePatternResolver().getResource("classpath:resources/config-mybatis.xml"));
...
//	}
	...
	DeleteArticleService deleteArticleService() {
		return new DeleteArticleService();
	}
